...
echo "  docker compose -p ailearning -f docker-compose.local.yml up -d"
echo ""
echo "Stop all services:"
echo "  docker compose -p ailearning -f docker-compose.local.yml down"
echo ""
echo "View service logs:"
echo "  docker compose -p ailearning -f docker-compose.local.yml logs [service_name]"
echo ""
...
echo "  docker compose -p ailearning -f docker-compose.local.yml pull"
echo "  docker compose -p ailearning -f docker-compose.local.yml up -d"
echo ""
...
log_info "  - View logs: docker compose -p ailearning -f docker-compose.local.yml logs"
log_info "  - Update services: docker compose -p ailearning -f docker-compose.local.yml pull"
echo ""
